...
public class TrieGrader {
    ...
    private void testAddWords(@NotNull AutoCompleteDictionaryTrie ac) {
    ...
    private void testWordsInOut(AutoCompleteDictionaryTrie ac) {
        ...
        feedback.append("'test' in dictionary: ").append(ac.isWord("test")).append(". 'testcases' in dictionary: ").append(ac.isWord("testcases")).append(". 'testone' in dictionary: ").append(ac.isWord("testone")).append(".");
    ...
    private void testPredictions(AutoCompleteDictionaryTrie ac) {
        ...
        feedback.append("Out of 'testone', 'testine', 'testell', and 'testing', ").append(count).append(" words were found.");
