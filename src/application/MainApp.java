...
public class MainApp extends Application {
     ...
     */
	void showInputErrorDialog(String inErr) {
     ...
     * 
     */
	void showLoadFileDialog(AutoSpellingTextArea ta) {
    	try {
    ...
    void showEditDistanceDialog(String selectedText) {
    	try {
    		// Load the fxml file and create a new stage for the popup
    ...
    void showEDResult(List<String> path) {
    ...
    void showMarkovDialog(textgen.MarkovTextGenerator mtg) {
    	try {
    		// Load the fxml file and create a new stage for the popup
    ...
    void showLoadStage(Stage loadStage, String text) {
